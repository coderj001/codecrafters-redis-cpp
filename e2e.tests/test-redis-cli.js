...
class RedisCliTester {
  ...
  async testBasicSetGet() {
    try {
      ...
      // SET command
      const setResult = await this.runRedisCliCommand([
        "SET",
        "test_key",
        "test_value",
      ]);
      ...
      console.log(
        success ? "✓ Basic SET/GET test passed" : "✗ Basic SET/GET test failed",
      );
      return success;
    } catch (err) {
  ...
  async testNonExistentKey() {
    try {
      ...
      console.log(
        success
          ? "✓ Non-existent key test passed"
          : "✗ Non-existent key test failed",
      );
      return success;
    } catch (err) {
  ...
  async testOverwriteValue() {
    try {
      ...
      console.log(
        success ? "✓ Overwrite test passed" : "✗ Overwrite test failed",
      );
      return success;
    } catch (err) {
  ...
  async testMultipleKeys() {
    try {
      ...
      console.log(
        success ? "✓ Multiple keys test passed" : "✗ Multiple keys test failed",
      );
      return success;
    } catch (err) {
  ...
  async testErrorHandling() {
    try {
      ...
      try {
        ...
        console.log(
          "✗ Error handling test failed: GET without key should error",
        );
        return false;
      } catch (err) {
      ...
      try {
        ...
        console.log(
          "✗ Error handling test failed: SET without value should error",
        );
        return false;
      } catch (err) {
